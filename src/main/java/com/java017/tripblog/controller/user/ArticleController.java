...
public class ArticleController {
    ...
    public ArticleController(ArticleService articleService,
                             UserService userService, CollectService collectService) {
...
//        list = articleService.findByUserIdForPage(user);
    ...
    @ResponseBody
    @GetMapping("/myFirstSearchOfPageForCollect")
    public List<Article> myFirstSearchOfPageForCollect(HttpSession session) {
        User user = (User) session.getAttribute("user");
        List<Collect> messagedList;
        List<Article> articles;
        messagedList = collectService.findByUserCollectId(user);
        articles = collectService.changeToArticle(messagedList);
        return articles;
    }
